...
public class MeasurePackageDetail implements IsSerializable, Comparable<MeasurePackageDetail> {
     ...
     * The package clauses.
     */
    private List<MeasurePackageClauseDetail> packageClauses = new ArrayList<>();

    /**
     * The qdm elements.
     */
    private List<QualityDataSetDTO> qdmElements = new ArrayList<>();

    /**
     * The supp data elements.
     */
    private List<QualityDataSetDTO> suppDataElements = new ArrayList<>();

    /**
     * The cql supp data elements.
     */
    private List<CQLDefinition> cqlSuppDataElements = new ArrayList<>();

    /**
     * The cql qdm elements.
     */
    private List<CQLDefinition> cqlQdmElements = new ArrayList<>();
     ...
     */
    private List<RiskAdjustmentDTO> riskAdjClauses = new ArrayList<>();

    /**
     * The risk adj vars.
     */
    private List<RiskAdjustmentDTO> riskAdjVars = new ArrayList<>();
     ...
     *
     * @param packageClauses the new package clauses
     */
     ...
     *
     * @param valueSetDate the new value set date
     */
     ...
     *
     * @param qdmElements the new qdm elements
     */
     ...
     *
     * @param suppDataElements the new supp data elements
     */
     ...
     *
     * @param cqlSuppDataElements the new supp data elements
     */
