...
**Note:** This operation is used for development and demonstration purposes.  Library rows can be very large and my require you to increase the "max_allowed_packet" global variable in MySQL.  Ex.  SET GLOBAL max_allowed_packet=20971520.
