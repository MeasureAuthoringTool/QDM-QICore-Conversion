...
@Component
@Slf4j
public class InterventionRecommendedConverter extends ConverterBase<ServiceRequest> implements ServiceRequestConverter {
    public static final String QDM_TYPE = "QDM::InterventionRecommended";

    public InterventionRecommendedConverter(CodeSystemEntriesService codeSystemEntriesService,
    ...
    public QdmToFhirConversionResult<ServiceRequest> convertToFhir(Patient fhirPatient, QdmDataElement qdmDataElement) {
        //http://hl7.org/fhir/us/qicore/qdm-to-qicore.html#8154-intervention-recommended
        //Constrain status to one or more of active, on-hold, completed
