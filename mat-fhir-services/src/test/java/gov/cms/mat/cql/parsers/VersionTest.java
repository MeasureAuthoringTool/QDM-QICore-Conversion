...
public class VersionTest {
    ...
    public void testVersionRegex() {
        ...
        assertTrue(!p.matcher("0.0.0").matches());
        assertTrue(!p.matcher("0.0.00").matches());

        assertTrue(!p.matcher("9.9").matches());
        assertTrue(!p.matcher("9").matches());
        assertTrue(!p.matcher("9.9.9").matches());
        assertTrue(!p.matcher("9.9.99").matches());
    }
}
